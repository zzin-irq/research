  ...
  return (
    <>
      ...
      <div className="max-w-content mx-auto px-4 md:px-12 py-16">
        <h1 className="font-serif text-3xl md:text-4xl font-bold mb-3 text-accent-dark">المواضيع</h1>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {topics.map(topic => (
            <Link
              ...
              className="group block p-8 rounded-xl border border-border bg-surface hover:border-primary transition-colors"
            >
